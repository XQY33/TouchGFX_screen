...
// 以下配置为 16:9(1920*1080) 30帧 的配置
	{0x3800, 0x01}, // HS	1920 1080  30帧
	{0x3801, 0x50}, // HS
	{0x3802, 0x01}, // VS
	{0x3803, 0xb2}, // VS
	{0x3804, 0x08}, // HW (HE)
	{0x3805, 0xef}, // HW (HE)
	{0x3806, 0x05}, // VH (VE)	ISP输入1951*1087
	{0x3807, 0xf1}, // VH (VE)
...
// 以下配置为 4:3(2592*1944) 15帧 的配置
//	{0x3800, 0x00}, // HS
//	{0x3801, 0x00}, // HS
//	{0x3802, 0x00}, // VS
//	{0x3803, 0x00}, //
//	{0x3804, 0x0a}, // HW (HE)	2623
//	{0x3805, 0x3f}, // HW (HE)
//	{0x3806, 0x07}, // VH (VE)
//	{0x3807, 0x9F}, // VH (VE)
//	{0x380c, 0x0B}, // HTS	2844 = 2592+252
//	{0x380d, 0x1C}, // HTS
//	{0x380e, 0x07}, // VTS	1968 = 1944+24
//	{0x380f, 0xB0}, // VTS
